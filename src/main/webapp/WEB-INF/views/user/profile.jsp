...
<main class="col-md-auto ml-sm-auto col-lg-10 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h4><i class="far fa-address-card"></i> | ${user.firstName} ${user.lastName}, №${user.personalNumber}</h4>
    </div>
    <div class="row mb-3">
        <label for="workedHoursPerMonth" class="col-sm-2 col-form-label">Hours worked this month:</label>
        <div class="col-sm-2">
            <input value="${user.workedHoursPerMonth}" class="form-control form-control-sm" id="workedHoursPerMonth"
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
            <input value="${user.truck.registrationNumber}" class="form-control form-control-sm" id="userTruck"
