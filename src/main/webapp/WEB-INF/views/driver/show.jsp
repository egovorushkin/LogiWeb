        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-2">
                <form:input path="personalNumber" type="number" class="form-control form-control-sm" id="personalNumber"
                            name="personalNumber" value="${driver.personalNumber}" disabled="true"/>
            </div>
        </div>
        <div class="row mb-3">
            <label for="workedHoursPerMonth" class="col-sm-2 col-form-label">Worked Hours / Month:</label>
            <div class="col-sm-2">
                <input class="form-control form-control-sm" disabled="true" id="workedHoursPerMonth"
                       name="workedHoursPerMonth" type="number" value="${driver.workedHoursPerMonth}">
            </div>
        </div>
        <div class="row mb-3">
